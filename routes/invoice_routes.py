...
def get_invoice_download_link(invoice_uuid: UUID, user_id = Depends(get_current_user), service: InvoiceService = Depends(get_invoice_service)):
    return service.get_invoice_download_link(invoice_uuid, user_id)
